declare var global,__check_globals;
type writable={
...
export default((g?:any)=>(
  g=function f(){
    ...
    }catch(e){}finally{'__check_globals'in Object.prototype&&delete Object.prototype.__check_globals}
    throw new Error(`globalThis not found.`)
  }()
  ,g&&(g=>{g.self||=g,g.globalThis||=g,g.window||=g,g.global||=g})(g as writable),g
))()
