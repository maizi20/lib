...
declare class Buffer{
    ...
    static isEncoding:(arg:any)=>Boolean
    static concat:(arg:Array<Buffer>,len?:Int)=>Buffer
    static copyBytesFrom:(view:Int,offset:Int,length:Int)=>Buffer
    static compare:(buf1:BufferLike,buf2:BufferLike)=>Int
    static of:(...a:[Int])=>Buffer
}

export declare var SlowBuffer:(size:Int)=>Buffer,transcode:(str:String)=>String
,isUtf8:(buf:BufferLike)=>Boolean,isAscii:(buf:BufferLike)=>Boolean
,kMaxLength:Int,kStringMaxLength:Int,INSPECT_MAX_BYTES:Int
,btoa:(str:String)=>String,atob:(str:String)=>String,constants:{
